...
async function deleteTechnology(techId) {
    ...
    try {
        const response = await fetch(`/planning/api/technologies/${techId}`, {method: 'DELETE'});
        const result = await response.json();
        if (response.ok) {
...
async function deleteTechnologyGroup(groupId) {
    ...
    try {
        const response = await fetch(`/planning/api/technology_groups/${groupId}`, {method: 'DELETE'});
        const result = await response.json();
        if (response.ok) {
