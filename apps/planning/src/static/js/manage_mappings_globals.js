...
const technologyListContainerDiv = document.getElementById(
...
const technicianSkillsListContainerDiv = document.getElementById(
  "technicianSkillsListContainer",
);

const technologyGroupListContainerDiv = document.getElementById(
  "technologyGroupListContainer",
);
const newTechnologyGroupNameInput = document.getElementById(
  "newTechnologyGroupName",
);
const addTechnologyGroupBtn = document.getElementById("addTechnologyGroupBtn");
const newTechnologyGroupSelect = document.getElementById(
  "newTechnologyGroupSelect",
);
const newTechnologyParentSelect = document.getElementById(
  "newTechnologyParentSelect",
);

const specialityListContainerDiv = document.getElementById(
...
const assignSpecialitySelect = document.getElementById(
  "assignSpecialitySelect",
);
const assignSpecialityBtn = document.getElementById("assignSpecialityBtn");
const technicianSpecialitiesContainerDiv = document.getElementById(
  "technicianSpecialitiesContainer",
);

// New DOM element for Task-Technology Mappings
const taskTechnologyMappingListContainerDiv = document.getElementById(
  "taskTechnologyMappingListContainer",
);
// DOM elements for the new "Add Task" form in Task-Technology Mappings section
const newTaskNameForMappingInput = document.getElementById(
  "newTaskNameForMapping",
);
const newTaskTechnologySelectForMapping = document.getElementById(
  "newTaskTechnologySelectForMapping",
);
const addNewTaskForMappingBtn = document.getElementById(
  "addNewTaskForMappingBtn",
);
...
function recordChange(
  ...
  const changeDetail = {
    type: type,
    description: `Field '${field}' for ${
      entityName || `ID: ${entityId}`
    } changed from '${oldValue}' to '${newValue}'`, // Generic description
    entity: entityName,
    entityId: entityId,
    field: field,
    oldValue: oldValue,
  ...
  if (type === "Task Assignment Add") {
    ...
    if (additionalInfo.groupName)
      changeDetail.description += ` to group '${additionalInfo.groupName}'`;
    if (additionalInfo.parentName)
      changeDetail.description += ` under parent '${additionalInfo.parentName}'`;
