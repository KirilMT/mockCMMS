...
from apps.planning.src.services.security import SecurityMiddleware
...
from apps.planning.src.extensions import db_manager
...
def create_app():
    ...
    def not_found(error):
        ...
        app.logger.warning(
            f"404 Not Found: The requested URL '{request.path}' was not found on the server."
        )
