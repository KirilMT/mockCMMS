...
from apps.workforceManager.src.services.planning_engine import PlanningEngine, ShiftDefinition
...
class TestShiftRotation:
    ...
    def test_technician_filtering_in_planning(self, app, planning_engine, setup_shift_teams):
        ...
        with app.app_context():
            ...
            plan_result = planning_engine.generate_plan(start_date, "weekend_maintenance")
    ...
    def test_unassigned_technician_exclusion(self, app, planning_engine, setup_shift_teams):
