...
**Goal:** Show only MOs assigned to the selected report team in Shift/Weekend reports.
...
### 2.2 Link Reports to Core CMMS Data (Priority: High)
...
**Background:**
- Reports currently use some dummy/hardcoded data
...
- [x] **Weekend Report - All Sections:**
  - ✅ Applied same linking logic as Shift Reports
...
**Files Modified:**
- ✅ `apps/reports/src/services/data_aggregator.py` - Added MO linking methods
...
**Goal:** Generate reports automatically when a shift ends, with the option to trigger generation
...
- [ ] Add a "Generate Report" button on the Reports list page, disabled if a report already exists for the current shift.
...
- [ ] Ensure Breakdowns section in Shift Reports picks up these auto-created MOs correctly.
...
- [ ] Update all report modals
  - Apply to Add/Edit modals in Shift Reports
  - Apply to Add/Edit modals in Weekend Reports
