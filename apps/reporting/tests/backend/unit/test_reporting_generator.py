...
from apps.reporting.src.services.report_generator import ReportGenerator
...
class TestReportGenerator:
    ...
    def test_generate_report_with_data_csv(self, generator, sample_data):
        ...
        with patch("apps.reporting.src.services.report_generator.os.makedirs"):
    ...
    def test_generate_report_with_data_pdf(self, generator, sample_data, tmp_path):
        ...
        parameters = {}
        generator._reporting_dir = str(tmp_path)
        path = generator.generate_report(
    ...
    def test_get_reactive_production_data_filters(self, generator):
        ...
        with patch(
            "apps.reporting.src.services.report_generator.MaintenanceOrder"
        ) as mock_mo:
    ...
    @patch(
        "apps.reporting.src.services.report_generator.ReportGenerator."
    ...
    def test_generate_pdf_report_redirect(self, mock_text_gen, generator):
        ...
        generator._reporting_dir = "temp_reporting"
    ...
    def test_get_reactive_production_data_all_filters(self, generator):
        ...
        with patch(
            "apps.reporting.src.services.report_generator.MaintenanceOrder", new=DummyMO
        ):
            mock_query = DummyMO.query.filter_by.return_value
            mock_query.filter.return_value = mock_query
            mock_query.all.return_value = []
...
class TestReportGeneratorDBIntegration:
    ...
    def generator(self, tmp_path):
        """Create a generator instance with a temporary reporting directory."""
        gen = ReportGenerator()
        # Override reporting directory to use temp path
        gen._reporting_dir = str(tmp_path / "reporting")
        return gen
    ...
    def test_init_paths(self):
        ...
        gen = ReportGenerator()
        assert "instance" in gen.reporting_dir
        assert "reporting" in gen.reporting_dir
    ...
    def test_generate_report_data_types(self, generator, sample_data):
        """Test generating reporting with different data types (incidents, tasks)."""
        # Test Incidents
...
class TestReportGeneratorBranchCoverage:
    ...
    def generator(self, tmp_path):
        gen = ReportGenerator()
        gen._reporting_dir = str(tmp_path)
        return gen
