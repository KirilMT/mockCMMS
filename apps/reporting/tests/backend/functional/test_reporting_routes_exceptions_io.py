    ...
    def test_export_report_from_json_file(self, app, tmp_path):
        ...
        with app.app_context():
            ...
            with app.test_request_context():
                session["user_id"] = 1
                with patch(
                    "apps.reporting.src.services.report_generator."
...
class TestReportingRouteRefreshScenarios:
    def test_sync_file_reporting_returns_when_reporting_dir_missing(self, app):
        with app.app_context():
            with (
                patch(
                ...
                mock_rg.return_value.reporting_dir = "C:/tmp/missing-reporting"
                _sync_file_reporting()

    def test_sync_file_reporting_imports_new_json_and_infers_report_types(self, app):
        added = {}
        ...
        with app.app_context():
            with (
                ...
                patch(
                    "apps.reporting.src.routes.reporting.json.load",
                    side_effect=[
                        {
                            "title": "Shift A",
                ...
                patch(
                    "apps.reporting.src.routes.reporting.db.session.add_all",
                ...
                base = "C:/tmp/reporting"
                mock_rg.return_value.reporting_dir = base
    ...
    def test_report_detail_weekend_flattens_handover_when_queries_fail(self, app):
        with app.app_context():
            ...
            with app.test_request_context():
                ...
                with (
                    patch(
                        "apps.reporting.src.routes.reporting.db.session.query",
