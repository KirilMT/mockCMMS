/**
 * E2E Test Global Setup for Reporting App
 */
...
// Configuration
const TEST_PORT = 5003; // Distinct port for Reporting App (5000=prod, 5001=core, 5002=planning)
const TEST_HOST = "127.0.0.1";
// Adjust path to root: apps/reporting/tests/frontend/e2e -> ../../../../..
const PROJECT_ROOT = path.resolve(__dirname, "../../../../..");
const INSTANCE_DIR = path.join(PROJECT_ROOT, "instance");
const TEST_DB_PATH = path.join(INSTANCE_DIR, "mockcmms_reporting_e2e.db");
...
async function globalSetup(config) {
  console.log("\n🚀 Reporting App E2E Test Global Setup Starting...\n");
