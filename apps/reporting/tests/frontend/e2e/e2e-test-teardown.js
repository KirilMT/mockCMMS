/**
 * E2E Test Global Teardown for Reporting App
 */
...
// Reporting module E2E database (correct path)
const REPORTING_E2E_DB_PATH = path.join(
  PROJECT_ROOT,
  "apps",
  "reporting",
  "instance",
...
async function globalTeardown(config) {
  console.log("\n🧹 Reporting App E2E Test Global Teardown Starting...\n");
  ...
  const instanceDirs = [
    path.dirname(REPORTING_E2E_DB_PATH),
