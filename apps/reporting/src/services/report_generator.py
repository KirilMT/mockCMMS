...
class ReportGenerator:
    """Generates reporting outputs in various formats."""

    def __init__(self):
        """Initialize with the reporting output directory path (lazy creation)."""
        app_root = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", ".."))
        self._reporting_dir = os.path.join(app_root, "instance", "reporting")

    @property
    def reporting_dir(self):
        """Get reporting output directory path."""
    ...
    def generate_report(
        ...
        file_path = os.path.join(self.reporting_dir, filename)
