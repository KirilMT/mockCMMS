/**
 * Filter data based on global search and specific filters.
...
/**
 * Apply filters with combined AND/OR logic.
 ...
 * @returns {boolean} True if the value passes the filter.
 */
...
/**
 * Get a paginated slice of the data.
 * @param {Array} data - The full data array.
 * @returns {Array} The paginated data slice.
 */
...
/**
 * Perform a global search across all visible columns.
