...
from src.services.db_utils import db, Asset, User, MaintenanceOrder, Role, Team, SparePart
...
class DataSimulationService:
    ...
    def _load_constants(cls):
        ...
        try:
            ...
            config_path = os.path.join(current_dir, "..", "config", "dropdown_options.json")
    ...
    def generate_random_users(count=10):
        ...
        team_names = DataSimulationService._constants.get("Team", {}).get("names", ["Team A", "Team B"])
        role_names = DataSimulationService._constants.get("User", {}).get("roles", ["Technician"])
        ...
        for _ in range(count):
            ...
            user.availability_status = DataSimulationService._get_option("User", "availability_status")
    ...
    def generate_random_orders(count=10):
        ...
        for i in range(count):
            ...
            mo_type = DataSimulationService._get_option("MaintenanceOrder", "order_type")
            ...
            frequency = DataSimulationService._get_option("MaintenanceOrder", "frequency")
            justification = DataSimulationService._get_option("MaintenanceOrder", "justification")
    ...
    def generate_random_spare_parts(count=10):
        ...
        for _ in range(count):
            ...
            manufacturer = DataSimulationService._get_option("SparePart", "manufacturer")
