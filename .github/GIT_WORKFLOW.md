...
git clone https://github.com/KirilMT/mockCMMS mockCMMS
...
# Commit the staged files with a Conventional Commits message
git commit -m "feat(scope): add a clear and concise description"
```

**Step 3.3: Keep Your Branch Updated**
...
**Step 3.4: Verify Tracking Status Before Pushing**
...
This project follows Semantic Versioning (SemVer). Versioning and changelog
generation are **fully automated** by Google Release Please based on your
Conventional Commit messages — you do not manually bump versions or edit
`CHANGELOG.md` in your feature branches.

**Version Format:** `MAJOR.MINOR.PATCH` (e.g., `1.1.0`)

- **MAJOR (`1.x.x`):** Incremented for incompatible API changes.
- **MINOR (`x.1.x`):** Incremented for new, backward-compatible features.
- **PATCH (`x.x.1`):** Incremented for backward-compatible bug fixes.
...
If you created a Draft PR in Step 3.5, mark it as ready for review:
...
**Step 7.1: How to Create a Draft Pull Request**
...
**Step 7.2: How to Continue Working on a Draft PR**
...
**Step 7.3: Marking the PR as Ready for Review**
