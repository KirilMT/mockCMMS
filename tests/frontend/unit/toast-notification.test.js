...
describe("ToastNotification", () => {
  ...
  test("TN-1.9: test_default_durations", () => {
    ...
    expect(
      document.querySelector(".toast-success").closest(".toast"),
    ).not.toBeNull();
    ...
    expect(
      document.querySelector(".toast-error").closest(".toast"),
    ).not.toBeNull();
    ...
    expect(
      document.querySelector(".toast-warning").closest(".toast"),
    ).not.toBeNull();
    jest.advanceTimersByTime(2);
    jest.advanceTimersByTime(300);
    ...
    jest.advanceTimersByTime(4999);
    expect(
      document.querySelector(".toast-info").closest(".toast"),
    ).not.toBeNull();
    jest.advanceTimersByTime(2);
    jest.advanceTimersByTime(300);
  ...
  test("TN-1.5: test_multiple_toasts_stack_correctly", () => {
    ...
    expect(container.children[0].querySelector(".toast-body").textContent).toBe(
      "Message 1",
    );
    expect(container.children[1].querySelector(".toast-body").textContent).toBe(
      "Message 2",
    );
  });
