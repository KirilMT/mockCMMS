...
describe("TableData Module", () => {
  ...
  test("TD-2.7: test_filter_with_empty_value_ignored", () => {
    table.filters = [{ column: "name", operator: "contains", value: "" }];
  ...
  test("TD-3.13: test_filter_operators", () => {
    ...
    // Test not_contains
    operatorTable.filters = [
      { column: "val", operator: "not_contains", value: "a" },
    ];
    ...
    // Test not_equals
    operatorTable.filters = [
      { column: "val", operator: "not_equals", value: "apple" },
    ];
    ...
    // Test starts_with
    operatorTable.filters = [
      { column: "val", operator: "starts_with", value: "b" },
    ];
    res = operatorTable.getFilteredData();
    ...
    // Test ends_with
    operatorTable.filters = [
      { column: "val", operator: "ends_with", value: "e" },
    ];
    res = operatorTable.getFilteredData();
  ...
  test("TD-3.14: test_filter_case_insensitive", () => {
    ...
    operatorTable.filters = [
      { column: "val", operator: "equals", value: "apple" },
    ];
