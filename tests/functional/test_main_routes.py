...
class TestAssetsPages:
    ...
    def test_assets_add_page_post_success(self, auth_client, app):
        ...
        with app.app_context():
            ...
            response = auth_client.post('/assets/add', data=asset_data, follow_redirects=False)
    ...
    def test_assets_add_page_post_validation_error(self, auth_client):
        ...
        try:
            response = auth_client.post('/assets/add', data=asset_data, follow_redirects=True)
    ...
    def test_asset_detail_page_loads(self, auth_client, sample_asset):
        ...
        assert sample_asset.name.encode() in response.data or sample_asset.asset_code.encode() in response.data
    ...
    def test_asset_edit_page_post_success(self, auth_client, sample_asset, app):
        ...
        response = auth_client.post(f'/assets/{sample_asset.id}/edit', data=updated_data, follow_redirects=False)
...
class TestMaintenanceOrdersPages:
    ...
    def test_mos_list_page_loads(self, auth_client, multiple_mos):
        ...
        assert response.status_code == 200
        assert b'maintenance' in response.data.lower() or b'order' in response.data.lower()
    ...
    def test_mo_add_page_post_success(self, auth_client, sample_asset, sample_user, app):
        ...
        with app.app_context():
            ...
            response = auth_client.post('/maintenance_orders/add', data=mo_data, follow_redirects=False)
    ...
    def test_mo_edit_page_post_success(self, auth_client, sample_mo, app):
        ...
        response = auth_client.post(f'/maintenance_orders/{sample_mo.id}/edit', data=updated_data, follow_redirects=False)
...
class TestSparePartsPages:
    ...
    def test_spare_part_add_page_post_success(self, auth_client, app):
        ...
        with app.app_context():
            ...
            response = auth_client.post('/spare_parts/add', data=part_data, follow_redirects=False)
    ...
    def test_spare_part_edit_page_post_success(self, auth_client, sample_spare_part, app):
        ...
        response = auth_client.post(f'/spare_parts/{sample_spare_part.id}/edit', data=updated_data, follow_redirects=False)
...
class TestUsersPages:
    ...
    def test_users_list_page_loads(self, auth_client, sample_user):
        ...
        assert response.status_code == 200
        assert b'user' in response.data.lower() or sample_user.username.encode() in response.data
