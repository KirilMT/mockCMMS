...
class TestSimulationUI:
    ...
    def test_trigger_breakdown(self, client, app):
        ...
        with app.app_context():
            ...
            mo = MaintenanceOrder.query.filter_by(asset_id=updated_asset.id, order_type="Reactive").first()
    ...
    def test_generate_data_ui(self, client, app):
        ...
        with app.app_context():
            ...
            # Test Assets
            response = client.post("/simulation/generate", data={
                "type": "assets",
                "count": 5
    ...
    def test_set_availability(self, client, app):
        ...
        with app.app_context():
            ...
            response = client.post("/simulation/set-availability", data={
                "user_id": user.id,
                "status": "Sick"
            }, follow_redirects=True)
